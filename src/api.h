...
#define MEG4_DISPATCH \
    ...
    case  9: meg4_api_cls((uint8_t)cpu_topi(0)); break; \
    case 10:  val = meg4_api_cget((uint16_t)cpu_topi(0),(uint16_t)cpu_topi(4)); break; \
    case 11:  val = meg4_api_pget((uint16_t)cpu_topi(0),(uint16_t)cpu_topi(4)); break; \
    case 12: meg4_api_pset((uint8_t)cpu_topi(0),(uint16_t)cpu_topi(4),(uint16_t)cpu_topi(8)); break; \
    case 13:  val = meg4_api_width((int8_t)cpu_topi(0),(str_t)cpu_topi(4)); break; \
    case 14: meg4_api_text((uint8_t)cpu_topi(0),(int16_t)cpu_topi(4),(int16_t)cpu_topi(8),(int8_t)cpu_topi(12),(uint8_t)cpu_topi(16),(uint8_t)cpu_topi(20),(str_t)cpu_topi(24)); break; \
    case 15: meg4_api_line((uint8_t)cpu_topi(0),(int16_t)cpu_topi(4),(int16_t)cpu_topi(8),(int16_t)cpu_topi(12),(int16_t)cpu_topi(16)); break; \
    case 16: meg4_api_qbez((uint8_t)cpu_topi(0),(int16_t)cpu_topi(4),(int16_t)cpu_topi(8),(int16_t)cpu_topi(12),(int16_t)cpu_topi(16),(int16_t)cpu_topi(20),(int16_t)cpu_topi(24)); break; \
    case 17: meg4_api_cbez((uint8_t)cpu_topi(0),(int16_t)cpu_topi(4),(int16_t)cpu_topi(8),(int16_t)cpu_topi(12),(int16_t)cpu_topi(16),(int16_t)cpu_topi(20),(int16_t)cpu_topi(24),(int16_t)cpu_topi(28),(int16_t)cpu_topi(32)); break; \
    case 18: meg4_api_tri((uint8_t)cpu_topi(0),(int16_t)cpu_topi(4),(int16_t)cpu_topi(8),(int16_t)cpu_topi(12),(int16_t)cpu_topi(16),(int16_t)cpu_topi(20),(int16_t)cpu_topi(24)); break; \
